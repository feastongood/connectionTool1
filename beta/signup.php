  ...
  <div class="col-md-12">
    <div class="panel-group" id="accordion">
      <div class="panel panel-default">
            ...
            <div class="col-md-8">
              ...
              <tr>
                <td>
                 ...
                 <p>and </p>
                 <select name="orgwork2" class="form-control">
                   <option value=""></option>
                   <option value="animal">Animal Rights</option>
                   <option value="arts">Arts + Culture</option>
                   <option value="children">Children + Youth</option>
             ...
             <td>
              <div class="form-group">
                <label for="orgskill">How does your organization solve problems?</label>
                ...
                <p>and </p>
                <select name="orgskill2" class="form-control">
                 <option value=""></option>
                 <option value="problem">Problem Solving</option>
                 <option value="systems">Systems Thinking</option>
                 <option value="data">Data / Analytics</option>
       ...
       <h5>Where can your organization be found?</h5>
<table>
  <tr>
   <td>
    <div class="form-group">
