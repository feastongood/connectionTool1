        ...
        <div class="container">
          ...
          <div class="col-md-4"> <!-- is 3 with icons -->
            <!--<ul>
              ...
              <ul class="nav-bar">
                <li><a onClick="mixpanel.track("Nav: The Feast");" href="projects/?p=2">The Feast</a></li>
                <li><a onClick="mixpanel.track("Nav: Coastermatic");" href="projects/?p=3">Coastermatic</a></li>
                <li><a onClick="mixpanel.track("Nav: Crisis Text");" href="projects/?p=4">Crisis Text Line</a></li>
